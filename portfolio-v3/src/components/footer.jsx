...
function Footer() {
    return (
        <footer className="w-full bg-[#171717] text-white pt-10 pb-5 mt-16 text-center text-sm border-t border-neutral-700">
            ...
            <div className="flex flex-row w-[80%] md:w-[50%] mx-auto items-center justify-between">
                <Updated />
            </div>
        </footer>
    )
