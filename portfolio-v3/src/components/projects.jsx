    ...
    return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-[#1e1e1e] border border-neutral-700 rounded-xl p-4 flex flex-col gap-4 text-neutral-300 text-sm leading-relaxed flex-2 h-[100%] hover:shadow-2xl hover:translate-y-[-2px] transition-all duration-300">
                ...
                <h3 className="text-lg">VerseVision</h3>
                ...
                <div className="flex flex-row gap-4 mt-auto">
                    <a href="https://github.com/noahvogtli/VerseVision" target="_blank" rel="noreferrer" aria-label="View VerseVision source code on GitHub" className="flex-1 bg-neutral-800 rounded-xl pl-4 pr-4 pt-2 pb-2 border border-neutral-700 inline-flex justify-center items-center gap-2 transition-colors duration-200 hover:bg-neutral-700 hover:border-neutral-600"><FaGithub></FaGithub>Github</a>
                    <a href="https://www.versevision.net" target="_blank" rel="noreferrer" aria-label="Visit the VerseVision website" className="flex-1 bg-neutral-800 rounded-xl pl-4 pr-4 pt-2 pb-2 border border-neutral-700 inline-flex justify-center items-center gap-2 transition-colors duration-200 hover:bg-neutral-700 hover:border-neutral-600"><FaLink></FaLink>Visit</a>
                </div>
            </div>
            <div className="bg-[#1e1e1e] border border-neutral-700 rounded-xl p-4 flex flex-col gap-4 text-neutral-300 text-sm leading-relaxed flex-2 h-[100%] hover:shadow-2xl hover:translate-y-[-2px] transition-all duration-300">
                <img src={digitalmedia} alt="21 Digital Media screenshot" className="w-full h-[50%] object-cover rounded-md"/>
                <h3 className="text-lg">21 Digital Media</h3>
                ...
                <div className="flex flex-row gap-4 mt-auto">
                    <a href="https://www.21digital.media" target="_blank" rel="noreferrer" aria-label="Visit the 21 Digital Media website" className="flex-1 bg-neutral-800 rounded-xl pl-4 pr-4 pt-2 pb-2 border border-neutral-700 inline-flex justify-center items-center gap-2 transition-colors duration-200 hover:bg-neutral-700 hover:border-neutral-600"><FaLink></FaLink>Visit</a>
                </div>
            </div>
            <div className="bg-[#1e1e1e] border border-neutral-700 rounded-xl p-4 flex flex-col gap-4 text-neutral-300 text-sm leading-relaxed flex-2 h-[100%] hover:shadow-2xl hover:translate-y-[-2px] transition-all duration-300">
                <img src={lavishlandscapes} alt="Lavish Landscapes screenshot" className="w-full h-[50%] object-cover rounded-md"/>
                <h3 className="text-lg">Lavish Landscapes</h3>
                <p className="text-xs text-zinc-500">React | Netlify</p>
            ...
            <div className="bg-[#1e1e1e] border border-neutral-700 rounded-xl p-4 flex flex-col gap-4 text-neutral-300 text-sm leading-relaxed flex-2 h-[100%] hover:shadow-2xl hover:translate-y-[-2px] transition-all duration-300">
                ...
                <h3 className="text-lg">Javascript Wrestlers</h3>
                ...
                <div className="flex flex-row gap-4 mt-auto">
                    <a href="https://github.com/noahvogtli/ProWrestlingTournament" target="_blank" rel="noreferrer" aria-label="View JavaScript Wrestlers source code on GitHub" className="flex-1 bg-neutral-800 rounded-xl pl-4 pr-4 pt-2 pb-2 border border-neutral-700 inline-flex justify-center items-center gap-2 transition-colors duration-200 hover:bg-neutral-700 hover:border-neutral-600"><FaGithub></FaGithub>Github</a>
                    <a href="https://javascriptwrestlers.netlify.app/" target="_blank" rel="noreferrer" aria-label="Visit the JavaScript Wrestlers website" className="flex-1 bg-neutral-800 rounded-xl pl-4 pr-4 pt-2 pb-2 border border-neutral-700 inline-flex justify-center items-center gap-2 transition-colors duration-200 hover:bg-neutral-700 hover:border-neutral-600"><FaLink></FaLink>Visit</a>
                </div>
            </div>
        </div>
        </>
