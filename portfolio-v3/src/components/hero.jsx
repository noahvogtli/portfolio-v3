    ...
    return (
        ...
        <div className="mt-32 md:mt-42 flex flex-col items-start">
            ...
            <div className="flex flex-row mt-8 mb-8 md:gap-6 gap-4">
                ...
                <button onClick={resumeLink} className="bg-neutral-800 rounded-xl pl-4 pr-4 pt-2 pb-2 border border-neutral-700 inline-flex items-center gap-2 transition-colors duration-200 hover:bg-neutral-700 hover:border-neutral-600 hover:cursor-pointer"><FaFileAlt />Resume<FaExternalLinkAlt size={12} className="hidden md:block"/></button>                
            </div>
            <TechStack />
